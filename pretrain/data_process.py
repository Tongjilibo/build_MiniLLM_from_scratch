'''
预训练语料的处理（本项目并未重新做预训练语料，直接使用的baby-llama2的百度网盘源项目）
- 直接从baby-llama2拷贝，https://github.com/DLLXW/baby-llama2-chinese/blob/main/data_process.py
- 也可以直接使用该项目处理好的文件：https://pan.baidu.com/share/init?surl=8o4gF-G68qfgOGWQXgAg3g，提取码6unr
'''
import json
import glob
import numpy as np
