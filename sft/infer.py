...
args.config_path = os.path.join(args.dir_path, 'MiniLLM-0.2B-WithWudao-SFT_Alpaca/bert4torch_config.json')
args.model_path = '../ckpt/MiniLLM-0.2B-WithWudao-SFT_Alpaca/final/model.pt'
